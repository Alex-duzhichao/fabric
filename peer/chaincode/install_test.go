...
func TestBadVersion(t *testing.T) {
	...
	args := []string{"-n", "example02", "-p", "github.com/Alex-duzhichao/fabric/examples/chaincode/go/chaincode_example02"}
	cmd.SetArgs(args)
...
func TestNonExistentCC(t *testing.T) {
	...
	args := []string{"-n", "badexample02", "-p", "github.com/Alex-duzhichao/fabric/examples/chaincode/go/bad_example02", "-v", "testversion"}
	cmd.SetArgs(args)
...
func installEx02() error {
	...
	args := []string{"-n", "example02", "-p", "github.com/Alex-duzhichao/fabric/examples/chaincode/go/chaincode_example02", "-v", "anotherversion"}
	cmd.SetArgs(args)
