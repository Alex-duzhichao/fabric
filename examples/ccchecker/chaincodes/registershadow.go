...
import (
	...
	nkpi "github.com/Alex-duzhichao/fabric/examples/ccchecker/chaincodes/newkeyperinvoke/shadow"
)

//all the statically registered shadow chaincodes that can be used
var shadowCCs = map[string]ShadowCCIntf{
	"github.com/Alex-duzhichao/fabric/examples/ccchecker/chaincodes/newkeyperinvoke": &nkpi.NewKeyPerInvoke{},
}
