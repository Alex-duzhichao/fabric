...
import (
	...
	"github.com/Alex-duzhichao/fabric/common/mocks/scc"
	...
	"github.com/Alex-duzhichao/fabric/core/common/ccpackage"
	...
	policymocks "github.com/Alex-duzhichao/fabric/core/policy/mocks"
...
func TestReinstall(t *testing.T) {
	...
	cds, err := constructDeploymentSpec("example02", "github.com/Alex-duzhichao/fabric/examples/chaincode/go/chaincode_example02", "0", [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}, true)
	if err != nil {
		t.FailNow()
	}
...
func TestMultipleDeploy(t *testing.T) {
	...
	//deploy 01
	cds, err = constructDeploymentSpec("example01", "github.com/Alex-duzhichao/fabric/examples/chaincode/go/chaincode_example01", "0", [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}, true)
	if err != nil {
		t.FailNow()
	}
...
func TestTamperChaincode(t *testing.T) {
	...
	//deploy 01
	cds, err := constructDeploymentSpec("example01", "github.com/Alex-duzhichao/fabric/examples/chaincode/go/chaincode_example01", "0", [][]byte{[]byte("init"), []byte("a"), []byte("1"), []byte("b"), []byte("2")}, true)
	if err != nil {
...
func testIPolDeploy(t *testing.T, iPol string, successExpected bool) {
	...
	cds, err := constructDeploymentSpec("example02", "github.com/Alex-duzhichao/fabric/examples/chaincode/go/chaincode_example02", "0", [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}, false)
	assert.NoError(t, err)
...
func testIPolUpgrade(t *testing.T, iPol string, successExpected bool) {
	...
	cds, err = constructDeploymentSpec("example02", "github.com/Alex-duzhichao/fabric/examples/chaincode/go/chaincode_example02", "1", [][]byte{[]byte("init"), []byte("a"), []byte("100"), []byte("b"), []byte("200")}, false)
	assert.NoError(t, err)
	cdsbytes, err = proto.Marshal(cds)
	assert.NoError(t, err)
