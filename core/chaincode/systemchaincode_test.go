...
import (
	...
	"github.com/Alex-duzhichao/fabric/core/scc/samplesyscc"
	...
	sysccs := []*scc.SystemChaincode{
		{
			Enabled:   true,
			Name:      "sample_syscc",
			Path:      "github.com/Alex-duzhichao/fabric/core/scc/samplesyscc",
			InitArgs:  [][]byte{},
...
func deploySampleSysCC(t *testing.T, ctxt context.Context, chainID string) error {
	...
	url := "github.com/Alex-duzhichao/fabric/core/scc/sample_syscc"
